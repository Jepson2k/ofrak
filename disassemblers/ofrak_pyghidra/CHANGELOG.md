...
- Add `PyGhidraAssemblerService`, a Ghidra SLEIGH `AssemblerServiceInterface` that assembles instructions for architectures keystone does not support (e.g. Xtensa, RISC-V), usable as the `assembler_service` for `Instruction.modify_assembly`.
